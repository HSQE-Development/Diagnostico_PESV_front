...
export default function Sidebar() {
  ...
  return (
    <div className={`hidden md:flex flex-col justify-between h-full shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px]  ${collapsed ? "md:w-56 lg:w-72" : "md:w-24"} transition-all`}>
