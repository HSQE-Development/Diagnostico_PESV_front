        ...
        return (
          ...
          >
            <Segmented
              ...
              onChange={(value) => handleSegmentChange(record, value, true)}
            />
          </ConfigProvider>
        );
      },
      ...
      },
      {
        ...
        render: (_, record) => (
          <Segmented
            ...
            onChange={(value) => handleSegmentQuestion(record, value, false)}
          />
        ),
      },
      {
        ...
        render: (_, record) => {
          ...
          const colors =
            conditionalColors[record.isArticuled ? 1 : 0] || defaultColors;
          return (
            <ConfigProvider
              theme={{
                components: {
            ...
            >
              <Segmented
                ...
                onChange={(value) => handleSegmentQuestion(record, 0, value)}
              />
            </ConfigProvider>
          );
        },
